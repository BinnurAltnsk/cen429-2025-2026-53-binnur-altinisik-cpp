...
call reportgenerator "-title:Travelexpense Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Travelexpense Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Travelexpense
call OpenCppCoverage.exe --export_type=binary:travelexpense_tests_unit_win.cov --sources src\travelexpense\src --sources src\travelexpense\header --sources src\tests\travelexpense -- build_win\build\Debug\travelexpense_tests.exe
